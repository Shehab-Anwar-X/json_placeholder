...
import '../model/comment.dart';import '../../domain/entities/comment_creation_data.dart';
...
class CommentRepository extends BaseCommentRepository {
  ...
  @override
  Future<List<Comment>> list({required int limit, required int offset, int? postId})async { 
    final result = await dataSource.list(limit: limit, offset: offset, postId: postId,);
