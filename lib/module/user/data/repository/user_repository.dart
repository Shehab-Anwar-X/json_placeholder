...
import '../model/user.dart';import '../../domain/entities/user_creation_data.dart';
...
class UserRepository extends BaseUserRepository {
  ...
  Future<List<User>> list({required int limit, required int offset})async { 
    final result = await dataSource.list(limit: limit, offset: offset,);
  ...
  @override
  Future<void> update({required int id, required UserCreationData newData})async { 
